...
export const VerifiedBadge = ({ className, type = 'blue' }: { className?: string, type?: 'blue' }) => {
  const color = "#1D9BF0";
  
  return (
    <svg viewBox="0 0 22 22" aria-label="Verified account" role="img" className={className} fill={color}>
      <g>
